        ...
        <Card>
          ...
          <CardContent className="flex flex-wrap gap-2">
            {content.skills.map(skill => (
              <div key={skill} className="flex items-center gap-2 bg-primary/10 text-primary-foreground dark:bg-purple-800 dark:text-white font-medium text-sm px-3 py-1 rounded-full transition-colors hover:bg-secondary hover:text-secondary-foreground dark:hover:bg-purple-700">
